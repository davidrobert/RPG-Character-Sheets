...
public class UnarmedStrike extends AbstractSimpleWeapon {
	...
	private static final int nameCode = R.string.weapon_simple_unarmed_strike;
	...
	static {
		List<HitDice> small = Arrays.asList(new HitDice(HitDiceType.d2));
		List<HitDice> medium = Arrays.asList(new HitDice(HitDiceType.d3));
