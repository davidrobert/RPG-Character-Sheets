...
public class Shuriken extends AbstractExoticRangedWeapon {
	private static final long serialVersionUID = 1L;

	private static BasicWeapon base;

	static {
		base = new BasicWeapon(R.string.weapon_exotic_shuriken, R.drawable.weapon_shuriken);
		base.setCost(2L);
		base.setCritical(2);
	...
	public Shuriken() {
		super(base, TypeMunition.SHURIKEN);
	}
}
