...
public class HitDiceTest extends AndroidTestCase {
	...
	public void testgetMaxValue() throws Throwable {		
		...
		Assert.assertEquals(2 * 4 - 1, new HitDice(2, HitDiceType.d4, -1).getMaxValue());
	...
	public void testgetMaxValue2() throws Throwable {				
		Assert.assertEquals(2 * 4 * 2, new HitDice(2, HitDiceType.d4, 0, 2).getMaxValue());
		Assert.assertEquals(1 * 6 * 3, new HitDice(1, HitDiceType.d6, 0, 3).getMaxValue());
		Assert.assertEquals(3 * 8 * 4, new HitDice(3, HitDiceType.d8, 0, 4).getMaxValue());
		
		Assert.assertEquals((2 * 4 - 1) * 2, new HitDice(2, HitDiceType.d4, -1, 2).getMaxValue());
		Assert.assertEquals((1 * 6 + 1) * 3, new HitDice(1, HitDiceType.d6, +1, 3).getMaxValue());
		Assert.assertEquals((3 * 8 + 0) * 4, new HitDice(3, HitDiceType.d8, 0, 4).getMaxValue());
	}
	...
	public void testgetMinValue2() throws Throwable {		
		Assert.assertEquals(2 * 1 * 2, new HitDice(2, HitDiceType.d4, 0, 2).getMinValue());
		Assert.assertEquals(1 * 1 * 3, new HitDice(1, HitDiceType.d6, 0, 3).getMinValue());
		Assert.assertEquals(3 * 1 * 4, new HitDice(3, HitDiceType.d8, 0, 4).getMinValue());
		
		Assert.assertEquals((2 * 1 - 1) * 2, new HitDice(2, HitDiceType.d4, -1, 2).getMinValue());
		Assert.assertEquals((1 * 1 + 1) * 3, new HitDice(1, HitDiceType.d6, +1, 3).getMinValue());
		Assert.assertEquals((3 * 1 + 0) * 4, new HitDice(3, HitDiceType.d8, 0, 4).getMinValue());
	}
